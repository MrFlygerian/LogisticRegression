...
axs[1].scatter(A['Weight'],A['Height'], c = T, cmap = 'copper_r', alpha = 0.4), axs[1].set_title('Height vs weight by Gender'),  axs[1].set_xlabel('Weight'), axs[1].set_ylabel('Height')
